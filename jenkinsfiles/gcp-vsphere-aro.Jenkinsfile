        ...
        properties([
            parameters([
                ...
                extendedChoice(name: 'PLATFORM', description: 'The managed clusters platform that should be tested',
                    value: 'aws,gcp,azure,vsphere,aro,rosa', defaultValue: 'gcp,vsphere,rosa', multiSelectDelimiter: ',', type: 'PT_CHECKBOX', visibleItemCount: 6),
                ...
                credentials(name: 'SUBMARINER_CONFIG', defaultValue: 'acm-2.7-subm-0.14-gcp-vsphere-aro', description: 'Submariner config for environment deploy',
