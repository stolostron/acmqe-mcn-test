        ...
        properties([
            parameters([
                ...
                extendedChoice(name: 'PLATFORM', description: 'The managed clusters platform that should be tested',
                    value: 'aws,gcp,azure,vsphere,osp,aro,rosa', defaultValue: 'rosa,osp,aro', multiSelectDelimiter: ',', type: 'PT_CHECKBOX', visibleItemCount: 7),
                ...
                credentials(name: 'SUBMARINER_CONFIG', defaultValue: 'acm-2.14-subm-0.21-rosa-osp-aro', description: 'Submariner config for environment deploy',
